...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        Node(
            ...
            remappings=[
                ("commands/motor/duty_cycle","commands/motor/duty_cycle_right_front"),
                ("commands/motor/duty_cycle_can","commands/motor/duty_cycle_right_rear_can"),
        ...
        Node(
            ...
            remappings=[
                ("commands/motor/duty_cycle","commands/motor/duty_cycle_left_front"),
